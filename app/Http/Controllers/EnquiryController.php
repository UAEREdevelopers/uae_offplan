...
class EnquiryController extends Controller
{
    ...
    public function sendBottomEnquiry(Request $request, $slug){
        ...
        $contentAdminZoho = "<b style='font-size:15px'> OFF PLANS leads Admin,</b> <br> <h2>Lead Details: </h2><br> ".$tableAdmin."<br><a href='https://uaere.ae/' target='_blank'>Visit Website</a>";
        $dataZohoAdmin = [
    ...
    public function sendEnquiry(Request $request, $slug){
        ...
        \Log::info(print_r($propertyData,true));
    ...
    public function checkMail(){
        ...
        \Log::info(print_r($dataZohoAdmin,true));
        $result_message_admin_zoho = $this->mailZohoSet($dataZohoAdmin);
        \Log::info(print_r($result_message_admin_zoho,true));
        return 1;
