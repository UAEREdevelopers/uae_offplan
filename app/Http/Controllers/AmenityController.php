...
class AmenityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('amenity_image')){
            ...
            $amenity_image->move(public_path('website/images/amenity_images/'), $amenity_image_new_name);
            $amenity->amenity_image = $amenity_image_new_name;
            $amenity->save();
        }

        if($request->hasFile('amenity_icon_image')){
            $amenity_icon_image = $request->amenity_icon_image;
            $amenity_icon_image_new_name = time() . '.' . $amenity_icon_image->getClientOriginalExtension();
            $amenity_icon_image->move(public_path('website/images/amenity_icon_images/'), $amenity_icon_image_new_name);
            $amenity->amenity_icon_image = $amenity_icon_image_new_name;
            $amenity->save();
        }
    ...
    public function update(Request $request, Amenity $amenity)
    {
        ...
        if($request->hasFile('amenity_image')){
            ...
            if(!empty($amenity->amenity_image)){
                unlink(public_path('website/images/amenity_images/'.$amenity->amenity_image));
            }
        ...
        if($request->hasFile('amenity_icon_image')){
            $amenity_icon_image = $request->amenity_icon_image;
            $amenity_icon_image_new_name = time() . '.' . $amenity_icon_image->getClientOriginalExtension();
            if(!empty($amenity->amenity_icon_image)){
                unlink(public_path('website/images/amenity_icon_images/'.$amenity->amenity_icon_image));
            }
