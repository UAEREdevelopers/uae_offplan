                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="link" value="{{ $property->link }}" class="form-control" placeholder="Enter Property Link Page">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="developer_id" id="developer_id" class="form-control">
                                                        ...
                                                        <option value="{{ $d->id }}" @if($property->developer_id == $d->id) selected @endif> {{ $d->title }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
