                                ...
                                <form action="{{ route('amenity.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="sub_heading_text">Amenity Heading Text</label>
                                                    <input type="name" name="heading_text" value="{{ old('heading_text') }}" class="form-control" placeholder="Enter Amenity Heading Text">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
