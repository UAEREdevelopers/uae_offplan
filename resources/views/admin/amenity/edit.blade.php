                                ...
                                <form action="{{ route('amenity.update', [$amenity->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-4 text-right">
                                                        <div style="max-width: 100px; max-height: 100px;overflow:hidden; margin-left: auto;">
                                                            <img src="{{ asset('website/images/amenity_images/'.$amenity->amenity_image) }}" class="img-fluid" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="amenity_icon_image">Amenity Icon Image</label>
                                                    <div class="custom-file">
                                                        <input type="file" name="amenity_icon_image" class="custom-file-input" id="amenity_icon_image">
                                                        <label class="custom-file-label" for="amenity_icon_image">Choose file</label>
                                                    </div>
                                                    <div class="col-4 text-right">
                                                        <div style="max-width: 100px; max-height: 100px;overflow:hidden; margin-left: auto;background: black;">
                                                            <img src="{{ asset('website/images/amenity_icon_images/'.$amenity->amenity_icon_image) }}" class="img-fluid" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
