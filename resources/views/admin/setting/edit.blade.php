                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group input-field">
                                                    <label for="exampleInputPassword1" class="active">Photos</label>
                                                        <div id="amenity_images" style="padding-top: .5rem;"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
@section('script')
    ...
    <script>
        <?php
            $mediaArrayText = '';
            $mediaArrayText .= '[';
            foreach($amenity_images as $media){
                
                $mediaArrayText .= '{id: '.$media->id.', src: "http://127.0.0.1:8000/website/images/amenities_images/'.$media->name.'"},';
        ...
        ?>
        let preloaded = <?php echo $mediaArrayText;?>;

        $('#amenity_images').imageUploader({
            preloaded: preloaded,
